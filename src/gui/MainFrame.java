...
import forklift.ForkliftAgent;
import forklift.ForkliftProblem;
...
public class MainFrame extends JFrame {
    ...
    private int[][] initialMatrix = {{0, 0, 0, 0, 2, 0}, 
                                     ...
                                     {0, 0, 0, 2, 3, 0}, 
                                     {0, 0, 0, 3, 0, 0}};
    private ForkliftAgent agent = new ForkliftAgent(new ForkliftState(initialMatrix));
    ...
    private ForkliftTableModel puzzleTableModel;
    ...
    private void jbInit() throws Exception {
        ...
        this.setTitle("Search Door Forklift");
    ...
    private void configureTabel(JTable table) {
        puzzleTableModel = new ForkliftTableModel(agent.getEnvironment());
        tablePuzzle.setModel(puzzleTableModel);
        
        tablePuzzle.setRowMargin(0);
        tablePuzzle.getColumnModel().setColumnMargin(0);
        table.setDefaultRenderer(Object.class, new ForkliftCellRenderer());
        ...
        SwingWorker worker = new SwingWorker<Solution, Void>() {
            public Solution doInBackground() {
                ...
                try {
                    ...
                    ForkliftProblem problem = new ForkliftProblem((ForkliftState) agent.getEnvironment().clone());
